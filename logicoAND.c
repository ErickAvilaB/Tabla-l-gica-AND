...
int main(){
	...
	printf("   1) n1>n2 and n1>n3\n");
	printf("   2) n2>n1 and n2>n3\n");
	printf("   2) n3>n1 and n3>n2\n\n");
	...
	// Imprimir tabla lógica AND
	printf("Representaci%cn de la tabla l%cgica AND.\n\n", 162, 162);
	...
	printf("\n");
	printf("  Programa Tabla l%cgica AND creado por: Avila Barba Erick Yahir\n\n", 162);
	getch();
